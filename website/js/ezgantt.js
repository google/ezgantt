...
async function main() {
    ...
    // When false, keep the order in the source table.  Default to true.
    /** @type {boolean} */
    let sortTasks = true;
    if(urlParams.has('sortTasks')) {
        sortTasks = urlParams.get('sortTasks') === 'true';
    }
    console.info(`Set sortTasks=${sortTasks}`);
